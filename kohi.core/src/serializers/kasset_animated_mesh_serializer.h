...
/**
 * @brief Attempts to deserialize the given block of memory into an animated_mesh asset.
 *
 ...
 */
KAPI b8 kasset_animated_mesh_deserialize(u64 size, const void* block, kasset_animated_mesh* out_asset);
